...
$(document).ready(function () {
	...
	$('#setup_menu').show();
	$('#account-logs_menu').addClass('selected');
...
<div style="padding:25px" class="hidden-print">
	<div style="font-size: 26px;color: gray;border-bottom: 1px solid lightgray;<?php echo (isset($_GET['success']) && $_GET['success']!='' && ($_GET['success']=='add' || $_GET['success'] == 'edit' || $_GET['success'] == 'delete') ? 'margin-bottom:0px' : 'margin-bottom:25px')?>" id="header2">Account Logs</div>
    ...
    <div style="border:1px solid lightgray;border-radius:4px">
        ...
        <div style="padding:5px">
        	<style>
				...
				th,#list td:nth-child(4),#list td:nth-child(6) {
				...
				<tr>
					<td width="29%">
						<div style="float:left;width:72%" class="input-group">
							...
							<input type="text" class="form-control" placeholder="Search Username" style="font-weight:normal" aria-controls="list" id="search">
						</div>
					</td>
        	...
        	<table width="100%" id="list">
              	<thead>
                    ...
                    <th>Account Name</th>
                    <th width="13%">Login Date</th>
					<th width="13%">Logout Date</th>
                    <th >Computer Name</th>
                </thead>
...
$(document).ready(function() {
	$('#print').click(function() {
		...
		$('iframe').attr('src','report/account_logs.php?type='+$('select').val()+'&value='+$('#search').val()+'&from='+$('#from').val()+'&to='+$('#to').val());
