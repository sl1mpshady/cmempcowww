...
<div style="padding:25px">
	<div style="font-size: 26px;color: gray;border-bottom: 1px solid lightgray;margin-bottom:25px" id="header2">Edit Product</div>
    ...
    <div style="border:1px solid lightgray;border-radius:4px">
    	<div style="padding:6px 10px;background-image: linear-gradient(to bottom, #ffffff 0%, gainsboro 158%);border-bottom: 1px solid lightgray;"><span class="glyphicon glyphicon-plus-sign"></span> Edit Product</div>
        <div style="padding:20px">
        	...
        	<table width="100%">
              ...
              <tr>
                ...
                <td><input type="text" class="form-control" id="id" value="<?php echo $product->prodName?>" /></td>
              </tr>
              <tr>
