...
//        $b=$data->subreportParameter;
    ...
    public function transferDBtoArray($host,$user,$password,$db_or_dsn_name,$cndriver="mysql") {
        ...
        {
            echo '<div style=" font-weight: normal; font-size: 28px; line-height: 28px; margin: 1em; font-family: monospace; text-align:center">Fail to connect to database.</div>';
            exit(0);
        }
...
//                    if(!$this->newPageGroup) {
        ...
        if($filename==""){
            ...
            $filename = uniqid(mt_rand(10, 15)).'_'.time().'.pdf';
         }
...
//						echo $out["hidden_type"]."<br/>";
            ...
            echo '<div style=" font-weight: normal; font-size: 28px; line-height: 28px; margin: 1em; font-family: monospace; text-align:center">No data found</div>';
            exit(0);
        }
